...
public class UpperBlock extends AbstractHopperBlock {
    ...
    public UpperBlock(AbstractBlock.Settings settings, int distance) {
        ...
        this.setDefaultState(this.stateManager.getDefaultState().with(FACING, Direction.UP).with(AbstractHopperBlock.ENABLED, true));
    }
    ...
    public BlockState getPlacementState(ItemPlacementContext ctx) {
        ...
        return this.getDefaultState().with(FACING, direction.getAxis() == Direction.Axis.Y ? Direction.UP : direction).with(AbstractHopperBlock.ENABLED, true);
    }
