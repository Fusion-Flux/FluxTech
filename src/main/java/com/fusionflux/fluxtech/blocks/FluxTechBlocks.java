  ...
  //  public static BlockEntityType<UpperBlockEntity> UPPER_BLOCK_ENTITY;
    ...
    public static void registerBlocks() {
      ...
      //  Registry.register(Registry.ITEM, new Identifier(FluxTech.MOD_ID, "jupper"), new BlockItem(JUPPER_BLOCK, new Item.Settings().group(FluxTech.FLUXTECH_GROUP)));
        ...
        REDSTONE_RANDOMIZER_BLOCK_ENTITY = Registry.register(Registry.BLOCK_ENTITY_TYPE, new Identifier(FluxTech.MOD_ID, "redstone_randomizer_entity"), FabricBlockEntityTypeBuilder.create(RedstoneRandomizerBlockEntity::new, REDSTONE_RANDOMIZER_BLOCK).build(null));
